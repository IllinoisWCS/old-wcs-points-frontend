...
class SignIn extends Component {
    ...
    ignoreInDropDown(name) {
      ...
      if (ignoreCase.includes('office hours') || ignoreCase.includes('committee') || ignoreCase.includes('girls who code')) {
        return true;
      }
      return false;
    }
        ...
        const panes = [
          ...
          { menuItem: 'Committee', render: () =>
            <Tab.Pane attached={false}>
                ...
                <br />
                <Button fluid onClick={() => this.handleSubmit('committee')}>Check-in</Button>
          ...
          { menuItem: 'Office Hour', render: () =>
            <Tab.Pane attached={false}>
                ...
                <br />
                <Button fluid onClick={() => this.handleSubmit('officeHour')}>Check-in</Button>
            </Tab.Pane> },
            ...
            { menuItem: 'Girls Who Code', render: () =>
              <Tab.Pane attached={false}>
                ...
                <br />
                  <Button fluid onClick={() => this.handleSubmit('gwc')}>Check-in</Button>
              </Tab.Pane> }
        ]
